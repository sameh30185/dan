		...
		'fields' => array_merge(
			array(
				...
				'h_typography_4' => array(
					...
					'description' => sprintf( __( 'Add custom fonts via uploading %s files.', 'us' ), '<strong>woff</strong>, <strong>woff2</strong>' ) . ' <a target="_blank" rel="noopener" href="'. $help_portal_url .'/' . $us_portal_link_theme_name . '/options/typography/#uploaded-fonts">' . __( 'Read more about it', 'us' ) . '</a>.',
					'type' => 'heading',
				),
	...
	'advanced' => array(
		...
		'fields' => array(
			...
			'og_enabled' => array(
				...
				'description' => '<a href="'. $help_portal_url .'/' . $us_portal_link_theme_name . '/general/seo/" target="_blank">' . __( 'Read more about it', 'us' ) . '</a>.<br>' . __( 'If you\'re using any SEO plugin, turn OFF this option to avoid conflicts.', 'us' ),
				'std' => 1,
